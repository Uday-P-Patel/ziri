...
export const policyTemplates: PolicyTemplate[] = [
  ...
  },
  {
    ...
    "title": "Full access for Engineering department",
    "description": "Grants complete access to all actions for users in the Engineering department with active status.",
    "policy": "@id(\"engineering-full-access\")\npermit (\n    principal,\n    action,\n    resource\n)\nwhen {\n    principal.user.department == \"engineering\" &&\n    principal.status == \"active\"\n};"
  },
  {
    "id": "research-limited-access",
    "category": "Department-Based",
    "title": "Limited access for Research department",
    "description": "Restricts Research department to only completion and embedding actions. Prevents access to expensive operations like fine-tuning or image generation.",
  ...
  },
  {
    ...
    "description": "Blocks access to expensive premium models for non-executive and non-ML engineering departments. Helps control costs by preventing accidental usage of high-cost models.",
  ...
  },
  {
    ...
    "description": "Comprehensive policy combining multiple conditions: Engineering department, active status, business hours, corporate network, and spend limits. Ideal for production environments.",
